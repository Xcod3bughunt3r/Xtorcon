...
project = u'Xtorcon'
copyright = u'2022, master@itsecurity.id'
...
from xtorcon._metadata import __version__
version = __version__
...
html_title = 'timaq4ygg2iegci7.onion: Xtorcon Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Xtorcon Docs'
...
latex_documents = [
  ('index', 'Xtorcon.tex', u'Xtorcon Documentation',
   u'Xcod3bughunt3r', 'manual'),
]
...
man_pages = [
    ('index', 'xtorcon', u'Xtorcon Documentation',
     [u'Xcod3bughunt3r'], 1)
]
